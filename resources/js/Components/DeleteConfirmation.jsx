...
const DeleteConfirmation = ({ setShowDeleteConfirmation, dataProps, handleDelete, isProcessing  }) => {
  return (
      <section className='w-full fixed left-0 top-0 flex flex-col justify-center items-center h-screen'>
          
    <div className='w-full fixed bg-black/70 left-0 top-0 h-screen' onClick={() => setShowDeleteConfirmation(false)}></div>
          <div className="bg-white relative rounded-md">
              ...
              <div className="p-6">
                  ...
                  <div className="flex gap-4 mt-4 justify-end items-center">
                      ...
                      <button className='px-4 py-2 text-sm bg-red-600 text-white rounded-md'  onClick={() => setShowDeleteConfirmation(false)} disabled={ isProcessing }>Tidak</button>
