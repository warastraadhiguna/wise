                ...
                <div className="w-full mx-auto">
                    <form className="w-full" onSubmit={(event) => action(event)} autoComplete="off">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">   
                                ...
                                <select
                                    ...
                                    disabled={dataProps.is_received}
                        ...
                        <div className="mt-4 mb-4 flex justify-end">
                            {dataProps.is_received != 1 &&  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded mr-4" type="submit" disabled={isProcessing}>
