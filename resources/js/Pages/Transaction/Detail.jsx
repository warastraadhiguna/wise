                ...
                <div className="flex flex-wrap -mx-3 mb-6 mt-3">
                    <div className="w-full px-3  border-2 border-gray-300">
                        ...
                        {!transaction.approve_transaction_date ?
                            ...
                            : <h3 className="text-sm bg-blue-400 font-bold text-center">Transactiond by {transaction.transaction_user.name} Approved by {transaction.approved_user.name}   </h3>}
