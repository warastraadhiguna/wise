...
const Payment = ({ setShowPaymentForm, dataProps, totalSum, errors, setIsProcessing, isProcessing, purchase, paymentStatusOptions, handleChange, selectedPaymentStatusOption, isEditNumberInput, auth, handleOptionChange, setIsEditNumberInput }) => {
    ...
    const [grandTotal, setGrandtotal] = useState(purchase.grand_total);
    ...
    const approveOrder = (e) => {
        ...
        router.put(`/purchase/${dataProps.id}`, updatedDataProps, {
            onSuccess: () => {
                            ...
                            <div className="w-full flex items-center mb-2">
                                ...
                                <div className="inline-block relative w-4/6">
                                    <Select
                                        ...
                                        isDisabled={purchase.deleted_at || isProcessing || purchase.approve_purchase_date || showUpdateConfirmation}
                                        styles={{
                                            control: (base) => ({
                                                ...base,
